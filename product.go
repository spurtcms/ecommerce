...
func (ecommerce *Ecommerce) ProductsList(offset int, limit int, filter Filter, tenantid int) (productlists []TblEcomProduct, totalcount int64, err error) {
	...
	productlist, _, err := Ecommercemodel.ProductList(offset, limit, filter, ecommerce.DB, tenantid)

	_, count, _ := Ecommercemodel.ProductList(0, 0, filter, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) EditProduct(productid int, tenantid int) (products TblEcomProduct, discountprice []TblEcomProductPricing, price []TblEcomProductPricing, err error) {
	...
	product, err := Ecommercemodel.ProductDetailsByProductId(productid, ecommerce.DB, tenantid)
	...
	offers, err1 := Ecommercemodel.ProductPricingByProductId(product.Id, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) UpdateProduct(Pc CreateProductReq, removeoff []int, tenantid int) error {
	...
	err := Ecommercemodel.UpdateProducts(product, ecommerce.DB, tenantid)
	...
	err3 := Ecommercemodel.RemoveOffers(price, removeoff, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) MultiDeleteProduct(productid []int, id int, tenantid int) error {
	...
	err := Ecommercemodel.DeleteSelectedProducts(product, productid, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) DeleteProduct(productid int, id int, tenantid int) error {
	...
	err := Ecommercemodel.DeleteSingleProducts(product, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) CheckSkuName(sku string, id int, tenantid int) (bool, error) {
	...
	flg, err := Ecommercemodel.SkuNameCheck(product, sku, id, ecommerce.DB, tenantid)
...
func (ecommerce *Ecommerce) SelectProductsChangeStatus(status int, productid []int, tenantid int) error {
	...
	err := Ecommercemodel.SelectProductsChangeStatus(productid, product, ecommerce.DB, tenantid)
...
func (Ecommerce *Ecommerce) AddToCart(cart EcommerceCart, tenantid int) (boolean bool, err error) {
	...
	count, err = EcommerceModel.GetCartCount(EcommerceModel{}, cart.CustomerID, cart.ProductID, Ecommerce.DB, tenantid)
	if err != nil {
		return false, err
	}

	err = EcommerceModel.AddToCart(EcommerceModel{}, count, cart, Ecommerce.DB, tenantid)
	if err != nil {
		return false, err
	}
...
func (Ecommerce *Ecommerce) GetProduct(productId int, productSlug string, tenantid int) (product EcommerceProduct, err error) {
	...
	product, err = Ecommercemodel.GetProduct(productId, productSlug, Ecommerce.DB, tenantid)
	if err != nil {
...
func (Ecommerce *Ecommerce) GetCartListById(customerId, limit, offset int, tenantid int) (cartList []EcommerceProduct, err error) {
	...
	cartList, err = EcommerceModel.GetCartListById(EcommerceModel{}, customerId, limit, offset, Ecommerce.DB, tenantid)
	if err != nil {
		return []EcommerceProduct{}, err
	}
...
func (Ecommerce *Ecommerce) RemoveProductFromCartlist(productId int, memberId int, tenantid int) (err error) {
	...
	err = EcommerceModel.RemoveProductFromCartlist(EcommerceModel{}, productId, memberId, Ecommerce.DB, tenantid)
	if err != nil {
		return err
	}
...
func (Ecommerce *Ecommerce) GetProductOrdersList(filter ProductFilter, sort ProductSort, customerId int, limit int, offset int, tenantid int) (orderedProductList []EcommerceProduct, count int64, err error) {
	...
	orderedProductList, count, err = EcommerceModel.GetProductOrdersList(EcommerceModel{}, filter, sort, customerId, limit, offset, Ecommerce.DB, tenantid)
	if err != nil {
...
func (Ecommerce *Ecommerce) UpdateProductViewCount(productId int, productSlug string, tenantid int) (err error) {
	...
	err = EcommerceModel.UpdateProductViewCount(EcommerceModel{}, productId, productSlug, Ecommerce.DB, tenantid)
	if err != nil {
...
func (Ecommerce *Ecommerce) GetCartListCountById(customerId int, tenantid int) (count int64, err error) {
	...
	count, err = EcommerceModel.GetCartListCountById(EcommerceModel{}, customerId, Ecommerce.DB, tenantid)
	if err != nil {
		return -1, err
	}
...
func (Ecommerce *Ecommerce) GetProductdetailsById(productId int, productSlug string, tenantid int) (product EcommerceProduct, err error) {
	...
	product, err = EcommerceModel.GetProductdetailsById(EcommerceModel{}, productId, productSlug, Ecommerce.DB, tenantid)
	if err != nil {
...
func (Ecommerce *Ecommerce) GetProductOrderDetailsById(productId int, productSlug string, customerId int, orderId int, tenantid int) (product EcommerceProduct, productOrderStatus []OrderStatus, err error) {
	...
	product, productOrderStatus, err = EcommerceModel.GetProductDetailsAndOrderStatus(EcommerceModel{}, productId, productSlug, customerId, orderId, Ecommerce.DB, tenantid)
	if err != nil {
...
func (ecommerce *Ecommerce) UpdateProductPricing(pricing TblEcomProductPricing, tenantid int) error {
	...
	err1 := Ecommercemodel.UpdateProductPricing(pricing, ecommerce.DB, tenantid)
